...
final class Configuration implements ConfigurationInterface
{
    ...
    private function createExtensions()
    {
        return $this->createNode('extensions')
            ->addDefaultsIfNotSet()
                ->children()
                    ->arrayNode('color-syntax')
                    ->addDefaultsIfNotSet()
                        ->children()
                            ->scalarNode('tui_code_color_syntax_js_path')->defaultValue('bundles/teebbtuieditor/tui.editor-bundles/node_modules/@toast-ui/editor-plugin-color-syntax/dist/toastui-editor-plugin-color-syntax.js')->end()
                    ...
                    ->addDefaultsIfNotSet()
                        ...
                        ->end()
                    ->end()
                    ->arrayNode('code-syntax-highlight')
                    ->addDefaultsIfNotSet()
                        ->children()
